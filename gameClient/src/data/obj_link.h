#ifndef gameClient_data_obj_link_h
#define gameClient_data_obj_link_h
    ...
    public:
        ...
        static connector::tcp_receiver::target configure(obj_link<objID, T, callbackParamT>* obj) {
            ...
            switch (obj->m_currentState.get()) {
                case states::recvCount: result = configure_count(obj); break;
                case states::recvData:  result = configure_data(obj); break;
            }            
        ...
        static bool complete(obj_link<objID, T, callbackParamT>* obj) {
            bool result = true;
            switch (obj->m_currentState.get()) {
                case states::recvCount: result =  complete_count(obj); break;
                case states::recvData:  result =  complete_data(obj); break;
            }   
