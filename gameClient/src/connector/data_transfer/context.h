...
namespace connector {
    namespace data_transfer {
        ...
        private:
            ...
            obj_link<types::data_transfer::content::session_id, session::controller> tcpTicketLink;
            ...
            static void complete_tcp_ticket_link(obj_link<types::data_transfer::content::session_id, session::controller>& obj, session::controller* sessionCtrl);
