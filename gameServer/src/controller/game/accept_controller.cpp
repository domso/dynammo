    ...
    namespace game {
        ...
        bool accept_controller::start() {
            ...
            if (m_isRunning.compare_exchange_strong(current, true)) {
                if (!m_socket.acceptOn(m_currentOptions.port, m_currentOptions.backlog)) {
                    return false;
                }

                m_socket.setTimeout(m_currentOptions.updateIntervall);
        ...
        void accept_controller::main_thread() {
            ...
            while (m_isRunning.load()) {
                ...
                if (connection != nullptr) {
                    ...
                    slot.connection->sendData<authentication::ticket_t>(&currentTicket, 1);
                }
