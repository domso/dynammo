...
namespace data {
    ...
    private:
        ...
        util::wait_lock::context_t<authentication::credentials_t> credentials_;
        util::wait_lock::context_t<std::queue<authentication::user_data_t>> users_;

        util::wait_lock::context_t<authentication::serverID_t> serverID_;
        util::wait_lock::context_t<bool> registerState_;
    };
}
